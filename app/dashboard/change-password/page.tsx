    ...
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl p-6 space-y-5">
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 pr-10 border border-border rounded-lg bg-background text-foreground focus:ring-2 focus:ring-primary"
              required
            />
        ...
        <button
          ...
          className="w-full py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 disabled:opacity-50 font-semibold transition-all flex items-center justify-center gap-2"
        >
